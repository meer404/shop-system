...
<div class="card">
  ...
  <form method="post" action="sale_new.php" id="saleForm">
    <div class="form-row">
      ...
      <button type="button" class="noprint" onclick="addRow()">زیادکردنی کاڵا+</button>
      <button type="submit" class="noprint">سەیڤ کردن</button>
    </div>
    ...
    <div class="form-row">
      ...
      <textarea id="note" name="note" rows="5" cols="120" placeholder="تێبینی بنووسە بۆ زانیاری زیاتر"></textarea>
    </div>
  </form>
</div>
...
<div class="form-row">
  <span class="badge"> کۆی گشتی $<strong id="subtotal">0.00</strong></span>
  <span class="badge"> داشکاندن $<strong id="discountShow">0.00</strong></span>
  <span class="badge"> کۆی گشتی دوای داشکاندن $<strong id="total">0.00</strong></span>
</div>
